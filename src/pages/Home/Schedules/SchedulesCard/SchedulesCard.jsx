    ...
    <>
      <div className="flex flex-col shadow-xl rounded-lg ">
        <div className="relative ">
          ...
          <h3 className="absolute bottom-1/4 left-6 text-xl md:text-2xl font-bold font-[archivo] text-white">
            {courseName}
          </h3>
        </div>
        <div className="flex flex-col py-3">
          <ul className="divide-y divide-[#480ca8] divide-opacity-10">
            <li className="flex justify-between p-4 text-sm md:text-base font-medium uppercase text-[#4361ee]">
              <span>Monday</span>
              <span>10 - 11 am</span>
            </li>
            <li className="flex justify-between p-4 text-sm md:text-base font-medium uppercase text-[#4361ee]">
